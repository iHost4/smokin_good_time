    ...
    <div class="container">
      <div class="row text-center">
        ...
        <div class="col-md-4 pb-1 pb-md-0">
			...
			<a href="./appetizers/appetizers.html">
			
          <div class="card">
            <img class="card-img-top" src="images/400X200.gif" alt="Card image cap">
            <div class="card-body">
              <h5 class="card-title">Appetizers&nbsp;</h5>
              <p class="card-text">Start your meal with a flavorful first bite perfect for sharing or savoring solo!&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</p>
        ...
        <div class="col-md-4 pb-1 pb-md-0">
			...
			<a href="./entree/entree.html">
			
          <div class="card">
            <img class="card-img-top" src="images/400X200.gif" alt="Card image cap">
            <div class="card-body">
              <h5 class="card-title">Entrees&nbsp;</h5>
              <p class="card-text">Satisfying mains crafted to delight every craving—hearty, flavorful, and made to impress.</p>
</div>
          </div>
      ...
      <div class="row text-center mt-4">
        <div class="col-md-4 pb-1 pb-md-0">
			...
			<a href="./kids-menu/kids-menu.html">
			
          <div class="card">
            <img class="card-img-top" src="images/400X200.gif" alt="Card image cap">
            <div class="card-body">
              <h5 class="card-title">Kids Menu&nbsp;</h5>
              <p class="card-text">&nbsp;Tasty bites for the little foodies: fun, flavorful, and perfectly portioned for young appetites.</p>
</div>
          </div>
